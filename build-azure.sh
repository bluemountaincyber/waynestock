...
echo -ne "\033[1m\033[4m\033[31mWARNING:\033[0m\033[1m\033[31m This will deploy all Waynestock infrastructure into your Azure account. Do you want to proceed? (y/n) \033[0m"
read -n 1 -r
echo
echo
if [[ ! $REPLY =~ ^[Yy]$ ]]; then
